package com.fernandohenry.myapplication;
        ...
        import com.fernandohenry.myapplication.Adapter.ViewPagerAdapter;
        import com.fernandohenry.myapplication.DB.FavoritesOperations;
        import com.fernandohenry.myapplication.Fragments.AllSongFragment;
        import com.fernandohenry.myapplication.Fragments.CurrentSongFragment;
        import com.fernandohenry.myapplication.Fragments.FavSongFragment;
        import com.fernandohenry.myapplication.Model.SongsList;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AllSongFragment.createDataParse, FavSongFragment.createDataParsed, CurrentSongFragment.createDataParsed {
    ...
    private String getTimeFormatted(long milliSeconds) {
        ...
        //Converte tempo total da musica
        int hours = (int) (milliSeconds / 3600000);
        int minutes = (int) (milliSeconds % 3600000) / 60000;
        int seconds = (int) ((milliSeconds % 3600000) % 60000 / 1000);
        // Adiciona horas no tempo da musica
        if (hours > 0)
